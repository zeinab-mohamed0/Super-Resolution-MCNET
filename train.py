...
def main():
    ...
    train_set = TrainsetFromFolder(
        os.path.join('C:/Users/User/Downloads/CZ_hsdbi/MCNet_datasetHarvardraw', 'train' + opt.datasetName, str(opt.upscale_factor))
    )
    train_loader = DataLoader(dataset=train_set, num_workers=opt.threads, batch_size=opt.batchSize, shuffle=True)    
    val_set = ValsetFromFolder(
        os.path.join('C:/Users/User/Downloads/CZ_hsdbi/MCNet_datasetHarvardraw', 'test', opt.datasetName, str(opt.upscale_factor))
    )
